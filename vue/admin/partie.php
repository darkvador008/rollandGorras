  ...
  <div class="col-md-6" id="<?php echo $i ?>" >
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        </button></div><div class="col-md-4"><button type="button" class="btn btn-default scorebtntop minus1"
         aria-label="Left Align" name="bouton" >
        <span class="glyphicon glyphicon-minus" aria-hidden="true" ></span>
      </button></div>
      
      <div class="col-md-4 scrj2" >Score j1= 15</div><div class="col-md-4"><button type="button" 
      class="btn btn-default scorebtntop plus2" aria-label="Left Align" name="bouton">
      <span class="glyphicon glyphicon-plus" aria-hidden="true" ></span>
    </button></div><div class="col-md-4">
    <button type="button" class="btn btn-default scorebtntop minus2" aria-label="Left Align"name="bouton">
    <span class="glyphicon glyphicon-minus" aria-hidden="true" ></span>
  </button></div>
