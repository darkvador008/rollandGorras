...
//            $('.pointSel01').html("aa");
            ...
            if (response[0] != null && response[0][1] != null) {
                var set = "";
                if (response[0][3] == 1) {
                    set = " " + response[0][6] + " / " + response[0][8];
                    if (response[0][10] != null) {
                        set += " / " + response[0][10];
                    }
                }
            ...
            if (response[0] != null && response[0][2] != null) {
                var set2 = "";
                if (response[0][3] == 1) {
                    set2 = " " + response[0][7] + " / " + response[0][9];
                    if (response[0][11] != null) {
                        set += " / " + response[0][11];
                    }
                }
            ...
            if (response[1] != null && response[1][1] != null) {
                var set = "";
                if (response[1][3] == 1) {
                    set = " " + response[1][6] + " / " + response[1][8];
                    if (response[1][10] != null) {
                        set += " / " + response[1][10];
                    }
            ...
            if (response[1] != null && response[1][2] != null) {
                var set = "";
                if (response[1][3] == 1) {
                    set = " " + response[1][7] + " / " + response[1][9];
                    if (response[1][11] != null) {
                        set += " / " + response[1][11];
                    }
            ...
            if (response[2] != null && response[2][1] != null) {
                var set = "";
                if (response[2][3] == 1) {
                    set = " " + response[2][6] + " / " + response[2][8];
                    if (response[2][10] != null) {
                        set += " / " + response[2][10];
                    }
            ...
            if (response[2] != null && response[2][2] != null) {
                var set = "";
                if (response[2][3] == 1) {
                    set = " " + response[2][7] + " / " + response[2][9];
                    if (response[2][11] != null) {
                        set += " / " + response[2][11];
                    }
            ...
            if (response[3] != null && response[3][1] != null) {
                var set = "";
                if (response[3][3] == 1) {
                    set = " " + response[3][6] + " / " + response[3][8];
                    if (response[3][10] != null) {
                        set += " / " + response[3][10];
                    }
            ...
            if (response[3] != null && response[3][2] != null) {
                var set = "";
                if (response[3][3] == 1) {
                    set = " " + response[3][7] + " / " + response[3][9];
                    if (response[3][11] != null) {
                        set += " / " + response[3][11];
                    }
            ...
            if (response[4] != null && response[4][1] != null) {
                var set = "";
                if (response[4][3] == 1) {
                    set = " " + response[4][6] + " / " + response[4][8];

                    if (response[4][10] != null) {
                        set += " / " + response[4][10];
                    }
            ...
            if (response[4] != null && response[4][2] != null) {
                var set = "";
                if (response[4][3] == 1) {
                    set = " " + response[4][7] + " / " + response[4][9];

                    if (response[4][11] != null) {
                        set += " / " + response[4][11];
                    }
            ...
            if (response[5] != null && response[5][1] != null) {
                var set = "";
                if (response[5][3] == 1) {
                    set = " " + response[5][6] + " / " + response[5][8];

                    if (response[5][10] != null) {
                        set += " / " + response[5][10];
                    }
            ...
            if (response[5] != null && response[5][2] != null) {
                var set = "";
                if (response[5][3] == 1) {
                    set = " " + response[5][7] + " / " + response[5][9];
                    if (response[5][11] != null) {
                        set += " / " + response[5][11];
                    }
            ...
            if (response[6] != null && response[6][1] != null) {
                var set = "";
                if (response[6][3] == 1) {
                    set = " " + response[6][6] + " / " + response[6][8];
                    if (response[6][10] != null) {
                        set += " / " + response[6][10];
                    }
            ...
            if (response[6] != null && response[4][1] != null) {
                var set = "";
                if (response[6][3] == 1) {
                    set = " " + response[6][7] + " / " + response[6][9];

                    if (response[6][11] != null) {
                        set += " / " + response[6][11];
                    }
